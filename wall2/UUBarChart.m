...
//            UUBar * bar = [[UUBar alloc] initWithFrame:CGRectMake((j+(_yValues.count==1?0.1:0.05))*_xLabelWidth +i*_xLabelWidth * 0.47, UULabelHeight, _xLabelWidth * (_yValues.count==1?0.8:0.45), chartCavanHeight)];
            if(!first)
            {
                ...
                bar.frame = CGRectMake(bar.frame.origin.x, bar.frame.origin.y, bar.frame.size.width, bar.frame.size.height);
            ...
            else
            {
                if(num%2==0)
                {
                    ...
                    bar.frame = CGRectMake(oldFrame.origin.x+oldFrame.size.width+distanceOne, bar.frame.origin.y, bar.frame.size.width, bar.frame.size.height);
                ...
                else
                {
                    ...
                    bar.frame = CGRectMake(oldFrame.origin.x+oldFrame.size.width+distaceTwo, bar.frame.origin.y, bar.frame.size.width, bar.frame.size.height);
